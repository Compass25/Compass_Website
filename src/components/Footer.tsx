        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-7 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              <AppNavLink to="/" className="text-gray-300 hover:text-primary transition-colors text-xs sm:text-sm lg:text-base text-high-quality nav-text-quality font-poppins ultra-sharp-text">
                Home
              </AppNavLink>
              <AppNavLink to="/packages" className="text-gray-300 hover:text-primary transition-colors text-xs sm:text-sm lg:text-base text-high-quality nav-text-quality font-poppins ultra-sharp-text">
                Packages
              </AppNavLink>
              <AppNavLink to="/about" className="text-gray-300 hover:text-primary transition-colors text-xs sm:text-sm lg:text-base text-high-quality nav-text-quality font-poppins ultra-sharp-text">
                About
              </AppNavLink>
              <AppNavLink to="/contact" className="text-gray-300 hover:text-primary transition-colors text-xs sm:text-sm lg:text-base text-high-quality nav-text-quality font-poppins ultra-sharp-text">
                Contact
              </AppNavLink>
            </div>
          </div>
