...
<img 
  src={image} 
  alt={title}
  className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 ease-out group-hover:scale-110 rounded-2xl" 
  style={{
    minWidth: '100%',
    minHeight: '100%',
    WebkitTransform: 'translateZ(0)', // Safari smooth scale fix
  }}
  loading="lazy"
/>
